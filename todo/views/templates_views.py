...
class TodoListView(ListView):
    model = Todo  # Todo 테이블 데이터 조회

    template_name = "todo/list.html"

    context_object_name = "todos"  # 템플릿에서 사용할 변수 이름

    ordering = ["-created_at"]  # created_at 기준 내림차순

    success_url = reverse_lazy("todo:list")  # 성공하면 이동할 url
